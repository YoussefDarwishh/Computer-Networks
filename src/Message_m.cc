...
void Message_Base::copy(const Message_Base& other)
{
    ...
    this->ACK_NACK_Number = other.ACK_NACK_Number;
...
void Message_Base::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->ACK_NACK_Number);
...
void Message_Base::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->ACK_NACK_Number);
    doParsimUnpacking(b,this->Payload);
    doParsimUnpacking(b,this->Checksum);
}

int Message_Base::getSeq_Num() const
{
    return this->Seq_Num;
}

void Message_Base::setSeq_Num(int Seq_Num)
{
...
int Message_Base::getACK_NACK_Number() const
{
    return this->ACK_NACK_Number;
}

void Message_Base::setACK_NACK_Number(int ACK_NACK_Number)
{
    this->ACK_NACK_Number = ACK_NACK_Number;
}
...
const bits& Message_Base::getChecksum() const
{
    return this->Checksum;
}

void Message_Base::setChecksum(const bits& Checksum)
{
...
unsigned int MessageDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_ACK_NACK_Number
...
int MessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "ACK_NACK_Number") == 0) return baseIndex + 2;
...
std::string MessageDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_ACK_NACK_Number: return long2string(pp->getACK_NACK_Number());
...
void MessageDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_ACK_NACK_Number: pp->setACK_NACK_Number(string2long(value)); break;
...
omnetpp::cValue MessageDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_ACK_NACK_Number: return pp->getACK_NACK_Number();
...
void MessageDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    switch (field) {
        ...
        case FIELD_ACK_NACK_Number: pp->setACK_NACK_Number(omnetpp::checked_int_cast<int>(value.intValue())); break;
